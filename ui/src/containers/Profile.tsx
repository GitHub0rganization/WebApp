...
import {NestTabs} from '../components/advanced/NestTabs'
        ...
        <MDBCol md="6">
            <MDBCard className="card-body p-4 round">
                <div className="user-image-name d-flex flex-row">
                    <img src="https://mdbootstrap.com/img/Photos/Avatars/avatar-1.jpg" className="rounded-circle float-left mr-4 z-depth-1" alt="aligment" />
